...
import 'package:ms_ess_potal/screens/dashboard/views/attendance_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(pageTitles[_selectedIndex], style: AppTextStyles.kBody16SemiBoldTextStyle,), // Display the title based on selected index
      ),
      body: PageView(
