                        ...
                        Row(
                          ...
                          children: [
                            CustomHomeCard(
                              ...
                              text: 'Sick Leave',
                              text1: ' ${sickLeave?.data?.lClBal ?? 0} ',
                                  // '/ ${sickLeave?.data?.totalYrBal ?? 0}'
                              subTitle: '0.666',
                            ...
                            CustomHomeCard(
                              ...
                              text: 'Earned Leave',
                              text1: ' ${leaveELBalance?.data?.lClBal ?? 0}',
                                  // ' / ${leaveELBalance?.data?.totalYrBal ?? 0}',
                              subTitle: '0.5',
                              iconButton: IconButton(
                                onPressed: () {
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            CustomHomeCard(
                              ...
                              text: 'Work From\nHome',
                              text1: ' ${leaveBalance?.data?.lClBal ?? 0}',
                                  // ' / ${leaveBalance?.data?.lOpBal ?? 0}',
                              subTitle: '0.5',
                              iconButton: IconButton(
                                onPressed: () {
